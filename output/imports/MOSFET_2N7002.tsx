...
export const MOSFET_2N7002 = (props: ChipProps<typeof pinLabels>) => {
  return (
    <chip
      pinLabels={pinLabels}
      ...
      footprint={<footprint>
        <smtpad portHints={["pin1"]} pcbX="1.0000mm" pcbY="-0.9500mm" width="1.0000mm" height="0.6500mm" shape="rect" />
        <smtpad portHints={["pin2"]} pcbX="1.0000mm" pcbY="0.9500mm" width="1.0000mm" height="0.6500mm" shape="rect" />
        <smtpad portHints={["pin3"]} pcbX="-1.0000mm" pcbY="0.0000mm" width="1.0000mm" height="0.6500mm" shape="rect" />
